...
export const PlayListData: Track[] = [
    {
        ...
        url: require('../../assets/music-assets/one.mp3'),
      },
      {
        id: 2,
        ...
        url: require('../../assets/music-assets/two.mp3'),
      },
      {
        id: 3,
        title: 'Kesariya',
        ...
        url: require('../../assets/music-assets/three.mp3'),
      },
      {
        id: 4,
        title: 'Title Track',
        ...
        url: require('../../assets/music-assets/four.mp3'),
      },
      {
        id: 5,
        title: 'Besharam Rang',
        ...
        url: require('../../assets/music-assets/five.mp3'),
      },
]